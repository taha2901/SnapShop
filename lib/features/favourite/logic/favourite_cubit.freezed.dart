...
class _$FavouriteLoadingImpl implements FavouriteLoading {
  ...
  @override
  String toString() {
    return 'FavouriteState.favouriteLoading()';
  }
...
abstract class _$$FavouriteSuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<FavouriteDataList> data});
}
...
class _$FavouriteSuccessImpl implements FavouriteSuccess {
  const _$FavouriteSuccessImpl({required final List<FavouriteDataList> data})
      : _data = data;
  ...
  @override
  String toString() {
    return 'FavouriteState.favouriteSuccess(data: $data)';
  }
...
abstract class FavouriteSuccess implements FavouriteState {
  const factory FavouriteSuccess(
      {required final List<FavouriteDataList> data}) = _$FavouriteSuccessImpl;
...
class _$FavouriteErrorImpl implements FavouriteError {
  const _$FavouriteErrorImpl({required this.message});
  ...
  @override
  String toString() {
    return 'FavouriteState.favouriteError(message: $message)';
  }
...
abstract class FavouriteError implements FavouriteState {
  const factory FavouriteError({required final String message}) =
