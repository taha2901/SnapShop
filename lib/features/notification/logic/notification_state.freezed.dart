...
class _$NotificationSuccessImpl implements NotificationSuccess {
  ...
  @override
  String toString() {
    return 'NotificationState.notificationSuccess(notificationDataList: $notificationDataList)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._notificationDataList, _notificationDataList));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_notificationDataList));
  ...
  TResult when<TResult extends Object?>({
    ...
    return notificationSuccess(notificationDataList);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return notificationSuccess?.call(notificationDataList);
  }
...
class _$NotificationErrorImpl implements NotificationError {
  const _$NotificationErrorImpl({required this.errorHandler});
  ...
  @override
  String toString() {
    return 'NotificationState.notificationError(errorHandler: $errorHandler)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return notificationError(errorHandler);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return notificationError?.call(errorHandler);
  }
...
abstract class NotificationError implements NotificationState {
  const factory NotificationError({required final ErrorHandler errorHandler}) =
