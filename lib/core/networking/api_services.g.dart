...
class _ApiServices implements ApiServices {
  ...
  Future<RegisterResponseBody> register(
      RegisterRequestBody loginRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<CategoriesDetailsResponseModel> getCategoriesDetails(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CategoriesDetailsResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CategoriesDetailsResponseModel _value;
    try {
      _value = CategoriesDetailsResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AddOrRemoveCartResponseModel> addOrRemoveCart(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addOrRemoveCartRequestModel.toJson());
    final _options = _setStreamType<AddOrRemoveCartResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddOrRemoveCartResponseModel _value;
    try {
      _value = AddOrRemoveCartResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AddressResponseModel> addAddress(
    ...
    final _options = _setStreamType<AddressResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
